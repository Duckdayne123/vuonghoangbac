...
function tapLove(id) {
  ...
  if (loveTaps.size === 4) {
    Swal.fire({
      title: 'Đủ 4 trái timm rồi nè!',
      text: 'quà của emm âyy nè 💖',
      timer: 1500,
      ...
      typeWriterEffect(
        `Chúc bé yêu của anh một ngày 1/6 thật vui vẻ, ngập tràn kẹo ngọt, ôm ấm và nụ cười! Dù lớn đến đâu thì với anh, em vẫn luôn là cô bé đáng yêu nhất thế gian. Happy Children's Day!`,
        'loveMsg',
        () => {
          const fromTag = document.createElement("div");
          fromTag.id = 'fromTag';
          fromTag.textContent = "anh iuu của emm";
...
async function inipesan() {
  ...
  if (typedName) {
    ...
    await Swal.fire({
      icon: 'warning',
      title: 'hong được để trống nhaaa!',
